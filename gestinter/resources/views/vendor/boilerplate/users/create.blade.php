            ...
            <div class="col-md-6">
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group {{ $errors->has('CDUSER') ? 'has-error' : '' }}">
                                {{ Form::label('CDUSER', __('boilerplate::users.usergestan')) }}
                                {{ Form::select('CDUSER', $users_gestan, old('user_gestan'), ['class' => 'form-control']) }}
                                {!! $errors->first('CDUSER','<p class="text-danger"><strong>:message</strong></p>') !!}
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="box box-info">
                    ...
                    <div class="box-body">       
                        ...
                        {!! $errors->first('roles','<p class="text-danger"><strong>:message</strong></p>') !!}                 
                    </div>
                </div>
            </div>
        </div>
