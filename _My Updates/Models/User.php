...
use Sebastienheyd\Boilerplate\Notifications\NewUserPassword as NewUserPasswordNotification;
...
class User extends Authenticatable
{
    ...
    protected $fillable = [ 'active', 'CDUSER', 'last_name', 'first_name', 'email', 'password', 'remember_token', 'last_login' ];
    protected $hidden = [  ];
     ...
     * @param string $token
     */
    public function sendNewUserPasswordNotification($token, $passwordText)
    {
        $this->notify(new NewUserPasswordNotification($passwordText));
    }
